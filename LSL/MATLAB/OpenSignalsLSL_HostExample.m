...
%   Example script to show how to receive a (multi-)channel signal stream from OpenSignals from
%   a specific host using the Lab Streaming Layer (LSL) and the hostname.
%
%   Notes:
%   -   This example is based on the official LSL 'ReceiveData.m' example which can be found here:
%       https://github.com/labstreaminglayer/liblsl-Matlab/blob/master/examples/ReceiveData.m
